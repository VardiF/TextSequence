...
The product exposes a real Streamable HTTP MCP server with 16 tools and eight
...
- 16 MCP tools with revision-safe mutations, timeline querying, deterministic revision diffs, and canonical marker edits
